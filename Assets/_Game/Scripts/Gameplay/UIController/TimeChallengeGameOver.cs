...
public class TimeChallengeGameOver : MonoBehaviour
{
    [SerializeField] private RectTransform _coinsRewardRect, _playerStatsRect, _coinIconRect;
    [SerializeField] private TextMeshProUGUI _playerBestWord, _wordsCount, _coinsEarnedText;
    ...
    private void CoinsEarnedAnimation()
    {
        ...
        sequence.onComplete += () =>
        {
            Timing.RunCoroutine(AnimateCoinIncrease(coins));
        };
    }
