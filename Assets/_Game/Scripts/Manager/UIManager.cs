...
public class UIManager : SingletonPersistent<UIManager>
{
    ...
    public void LoadMenuScene()
    {
        ...
        LoadingAnimation.Instance.AnimationLoading(0.5f, () =>
        {
            ...
            _sceneStartupHandle.Completed += handle =>
            {
                ...
                if (PlayerPrefs.GetInt(GameConstants.PLAYER_PREFS_IS_ADS_ENABLED) == 1 && GameManager.Instance.IsGameOver && shouldPlayAd)
                {
                    ToggleAdBreak(true);
    ...
    public void OnClickAddCoinButton()
    {
        ...
        HomeUIController.Instance.NavigateToShop();
    }
    #endregion
