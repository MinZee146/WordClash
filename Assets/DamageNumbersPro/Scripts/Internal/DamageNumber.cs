        ...
        */
            ...
            if (IsMesh())
            {
                ...
                if (!fallbackDictionary.ContainsKey(fontAsset) && fontAsset != null)
                {
                    ...
                    { 
                        ...
                        var textString = System.Char.ConvertFromUtf32((int) fontAsset.characterTable[0].unicode);
        ...
        public void UpdateText()
        {
            ...
            if (enableNumber)
            {
                ...
                {
                    //Digits:
                    var allDigits = Mathf.RoundToInt(Mathf.Abs(number) * Mathf.Pow(10, digitSettings.decimals)).ToString();
                    ...
                    var integers = allDigits.Substring(0, Mathf.Max(0, allDigits.Length - usedDecimals));
                    ...
                    var decimals = allDigits.Substring(allDigits.Length - usedDecimals);
